...
media-ctl -V '"Intel IPU4 CSI2 BE SOC":0 [fmt:'$format'/'$res']'
...
media-ctl -l '"Intel IPU4 CSI-2 0":1 -> "Intel IPU4 CSI2 BE SOC":0[1]'
media-ctl -l '"Intel IPU4 CSI2 BE SOC":1 -> "Intel IPU4 CSI2 BE SOC capture":0[1]'
